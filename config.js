...
// Auth information
global.pairNumber = "918767585726";                         // Add your paining number with country code example "916297175943"; 
...
global.github = "https://github.com/NehaSama4833";
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["Neha_Sama"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["918767585726"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["918767585726"];
global.OwnerName = process.env.OWNER_NAME || "Neha";
global.BotName = process.env.BOT_NAME || "Natsu-MD";
global.packname = process.env.PACK_NAME || "Natsu Bot";
global.author = "By: Neha Sama";
global.BotSourceCode = "https://github.com/NehaSama4833/A17";
